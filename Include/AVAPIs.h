...
------------|------------------|---------------|-------------------
 ...
 1.2.7.0    |Kevin             |2012-05-22     |Fix Bug : avServStart() crash when connection failed because double free "idx". Modify : TIME_DELAY_INITIAL 4->0 for video not delay.
 ...
 *
 */
AVAPI_API int  avServStart(int nIOTCSessionID, const char *cszViewAccount, const char *cszViewPassword, unsigned long nTimeout, unsigned long nServType, unsigned char nIOTCChannelID);
 ...
 *
 */
AVAPI_API int  avServStart2(int nIOTCSessionID, authFn pfxAuthFn, unsigned long nTimeout, unsigned long nServType, unsigned char nIOTCChannelID);
 ...
 *
 */
AVAPI_API int  avServStart3(int nIOTCSessionID, authFn pfxAuthFn, unsigned long nTimeout, unsigned long nServType, unsigned char nIOTCChannelID, int *pnResend);
 ...
 *
 */
AVAPI_API void avServSetResendSize(int nAVChannelID, unsigned long nSize);
 ...
 *
 */
AVAPI_API void avServSetMaxBufSize(unsigned long nMaxBufSize);
 ...
 *
 */
AVAPI_API void avClientSetMaxBufSize(unsigned long nMaxBufSize);
